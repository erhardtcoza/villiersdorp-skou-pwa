...
const modules: readonly Module[] = [
  ...
  { key: "pos", icon: "🧾", title: "Hek POS", detail: "Hekkaartjies, verkope en dagafsluiting", roles: ["staff", "committee"], href: "https://app.villiersdorpskou.co.za/?module=pos", permissions: ["pos_sales"] },
  { key: "bar-pos", icon: "🍻", title: "Kroeg POS", detail: "Kroegverkope, Yoco en beursiebetalings", roles: ["staff", "committee"], href: "https://app.villiersdorpskou.co.za/?module=bar-pos", permissions: ["bar_pos"] },
  ...
  { key: "kitchen-pos", icon: "🍽️", title: "Kombuis POS", detail: "Kombuisverkope en toekomstige afdelings", roles: ["staff", "committee"], href: "https://app.villiersdorpskou.co.za/?module=kitchen-pos", permissions: ["kitchen_pos"] },
  { key: "gates", icon: "📷", title: "Hek scan in / uit", detail: "Skandeer kaartjies en monitor toegang", roles: ["staff", "committee"], href: "https://app.villiersdorpskou.co.za/?module=gates", permissions: ["gates_scan"] },
  ...
  { key: "horse-processing", icon: "📋", title: "Verwerk perde-aansoeke", detail: "Personeel queue en opvolgstatus", roles: ["staff", "committee"], href: "https://app.villiersdorpskou.co.za/perde", permissions: ["horses_entries", "horses_approve"] },
